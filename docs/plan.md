...
Status as of 2026-07-02: M0–M8 done (each merged + CI-green, review-gated per the
execution protocol below). M9 in progress — acceptance walk in
`docs/acceptance-vt27-mvp.md` (0 ❌, 2 ⚠️ minor coverage gaps, 2 👤 require the council's
own real-file/real-machine check), version stamped `0.1.0`; remaining before tag: the
👤 items (VT27 dry run with the real file, fresh-machine install check).

| # | Status | Milestone | Scope (condensed) | Exit criteria |
|---|---|---|---|---|
